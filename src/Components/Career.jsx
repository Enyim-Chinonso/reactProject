  ...
  return (
    ...
    <div className='ms-5 mt-5'>
       <h1 style={{color:"red"}}>My Goals/Visions</h1>
        ...
        <ul>
            <li>I must get a remote dollar paying Tech job before the month of November, 2025. </li>
            <li>I must set up my business/company running on or before 35 years of my age.</li>
            <li>I must get married on or before 35 years. </li>
